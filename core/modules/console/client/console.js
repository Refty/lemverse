...
Template.console.events({
    'focus .js-command-input': function () {
        toggleUIInputs(true)
    },
    'blur .js-command-input': function () {
        toggleUIInputs(false)
    },
    'change .console-file': function (event) {
        markInputFileWithContent(!!event.currentTarget.files.length)
    },
