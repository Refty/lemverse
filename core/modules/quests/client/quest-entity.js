...
Template.questEntity.events({
    'click .js-quest-create': function (event, templateInstance) {
    ...
    'click .js-quest-subscribe': function (event, templateInstance) {
        event.preventDefault()
        event.stopPropagation()
...
Template.questEntity.helpers({
    ...
    title() {
        return Template.instance().entity.get().name || 'Quest builder'
    },
})
