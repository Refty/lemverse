...
const zoneMessagingAllowed = (zone, user) => {
    ...
    if (!level.guildId)
        throw new Meteor.Error(
            ...
            'Guild not linked to the level. You must link a guild to the level or remove the "messagingRestrictedToGuild" attribute'
        )
...
export { canSubscribeToNotifications, messagingAllowed, messageModerationAllowed, permissionType }
