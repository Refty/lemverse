...
Template.tileImg.helpers({
    tileset() {
        return Tilesets.findOne(this.tilesetId)
    },
    tileToTilesetX() {
...
Template.tilesetToolbox.helpers({
    ...
    selectedTilesIndex() {
        return Session.get('selectedTiles')?.index
    },
    selectedTilesId() {
        return Session.get('selectedTilesetId')
    },
})
