    ...
    Meteor.call('updateUserProfile', fields, (error) => {
        ...
        userManager
            ...
            ?.setName(
                ...
                fields.baseline || profile.baseline,
                fields.nameColor || profile.nameColor
            )
...
Template.settingsBasic.helpers({
    ...
    nameColors() {
        return Object.keys(Meteor.settings.public.character.nameColors || [])
    },
})

Template.settingsBasic.events({
    'input .input, input .js-name-color': function (event, templateInstance) {
